...
<div>
	...
	<form name="due_diligence">
		<div class="item_wrapper">
			...
			<div class="left-w80 "><input type="text" placeholder="저장 시 부여됨" name="planId" class="inputBox" readonly></div>
		</div>
		<div class="item_wrapper">
	...
	<div class="item_wrapper">
		<button class="btn btn-primary right" onclick="return setDueDiligencePlan(this)">등록</button>
	</div>
</div>